...
import com.freddy.chat.utils.encry.RSAUtil;
...
//        InputStream in = TestHttpEncrypt.class.getClassLoader().getResourceAsStream("src/main/client.properties");
//        prop.load(in);
